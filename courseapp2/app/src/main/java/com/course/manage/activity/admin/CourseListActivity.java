...
public class CourseListActivity extends AppCompatActivity implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bgaRefreshLayoutAdapter = new BGARecyclerViewAdapter<Course>(recyclerView, R.layout.item_course) {
            @Override
            protected void fillData(BGAViewHolderHelper helper, int position, Course model) {
                ...
                helper.getTextView(R.id.tv_teacher).setText(model.getTeacherName());
                ...
                helper.getTextView(R.id.tv_edit).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(CourseListActivity.this,CourseEditActivity.class).putExtra("course_id",model.getId()));
                    }
                });
        ...
        binding.ivAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CourseListActivity.this,CourseEditActivity.class));
            }
        });
    }
    public void deleteCourse(int courseId){
        RequestParams requestParams = new RequestParams(HttpUtils.courseDelete+"?token="+App.token);
    ...
    public void onBGARefreshLayoutBeginRefreshing(BGARefreshLayout refreshLayout) {
        RequestParams requestParams = new RequestParams(HttpUtils.courselist+"?token="+ App.token);
        HttpUtils.post(requestParams, new HttpUtils.HttpCallack() {
            @Override
            public void onSuccess(String result) throws JSONException {
