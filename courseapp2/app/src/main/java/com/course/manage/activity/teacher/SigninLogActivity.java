...
public class SigninLogActivity extends AppCompatActivity implements BGARefreshLayout.BGARefreshLayoutDelegate {
    private ActivitySigninLogBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImmersionBar.with(this)
                ...
                .init();
        binding = ActivitySigninLogBinding.inflate(getLayoutInflater());
        ...
        binding.ivQrcode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SigninLogActivity.this, SigninQrActivity.class).putExtra("course_id",courseId));
            }
        });
    }
    ...
    public void onBGARefreshLayoutBeginRefreshing(BGARefreshLayout refreshLayout) {
        RequestParams requestParams = new RequestParams(HttpUtils.teacherSigninlist+"?token="+ App.token);
