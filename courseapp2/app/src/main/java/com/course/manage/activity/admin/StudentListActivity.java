...
public class StudentListActivity extends AppCompatActivity implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    public void onBGARefreshLayoutBeginRefreshing(BGARefreshLayout refreshLayout) {
        RequestParams requestParams = new RequestParams(HttpUtils.studentList+"?token="+ App.token);
