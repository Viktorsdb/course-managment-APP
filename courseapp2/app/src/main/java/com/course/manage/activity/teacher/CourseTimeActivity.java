...
public class CourseTimeActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate {
    private ActivityCourseTimeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCourseTimeBinding.inflate(getLayoutInflater());
            ...
            protected void fillData(BGAViewHolderHelper helper, int position, CourseTime model) {
                ...
                if (courseList.size()==0){
                    ...
                    for (int i = 0; i < courseList.size(); i++) {
                        ...
                        detail.append("(").append(course.getLocation()).append(")");
                        detail.append("\r\n");
                    }
                }
